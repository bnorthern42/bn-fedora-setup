...
* 02 Visuals & UI
** Theme, Modeline, Fonts, Scrolling, and Fill Column
#+begin_src elisp
...
** Delimiters, Tabs, Side Windows, and Which-Key
#+begin_src elisp
...
* 04 Modal Editing & Core Keybindings
#+begin_src elisp
(use-package evil
  :ensure t
  :demand t
...
* 05 Project Management & Navigation
** Projectile, Imenu, and project.el
#+begin_src elisp
...
* 06 Elixir and HEEx Development
** Elixir Mode, Alchemist, and Credo
#+begin_src elisp
...
* 07 Language Server Configuration
** Eglot Servers and Hooks
#+begin_src elisp
(use-package eglot
  :ensure nil
  :config
...
* 08 Modern C++ Development and Terminal Tools
#+begin_src elisp
...
* 09 Language Server Mouse Navigation
#+begin_src elisp
...
* 11 Reloading & Session Restoration
#+begin_src elisp
